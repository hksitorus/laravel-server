...
RUN apt-get update -y && \
    apt-get install -y nano openssl unixodbc zip unzip git wget libfreetype6-dev libjpeg62-turbo-dev libpng-dev libldb-dev libldap2-dev unixodbc-dev libaio-dev supervisor
...
RUN docker-php-ext-configure gd --with-freetype-dir=/usr/include/ --with-jpeg-dir=/usr/include/  && \
    ...
    docker-php-ext-install -j$(nproc) gd ldap oci8 pdo mbstring zip pcntl bcmath sqlsrv pdo_sqlsrv
