...
RUN apt-get update -y && \
    apt-get install -y nano openssl unixodbc unixodbc-dev libgss3 odbcinst msodbcsql locales zip unzip git wget libfreetype6-dev libjpeg62-turbo-dev libpng-dev libldb-dev libldap2-dev libaio-dev supervisor librabbitmq-dev libgmp-dev zlib1g-dev libicu-dev g++ libmagickwand-dev imagemagick
